...
// Get the first 10 queue numbers
...
$sql_count = "SELECT COUNT(*) as total FROM queue WHERE status IN ('Waiting', 'Serving') AND DATE(created_at) = CURDATE()";
$count_result = mysqli_query($conn, $sql_count);
$total_queues = mysqli_fetch_assoc($count_result)['total'];
...
<head>
    ...
    <script>
        ...
        setInterval(checkForNewServe, 3000);
    </script>
</head>
<body>
...
<div class="main-wrapper">
    ...
    <div class="container-left">
        ...
        <?php if ($total_queues > 10): ?>
            <!--<a href="display2.php" class="btn btn-primary">Show More</a>-->
        <?php endif; ?>
    </div>
