...
/* =====================*/
ALTER TABLE `tellers`  
MODIFY COLUMN `role` ENUM('admin','tellerwithdraw','tellerdeposit','telleropenaccount','tellerdocumentation','tellercrewing','tellertechops','tellersourcing','tellertanker','tellerwelfare') NOT NULL;


ALTER TABLE `tellers` 
ADD COLUMN `department` ENUM('ADMIN','ACCOUNTS','TELLERWITHDRAW','TELLERDEPOSIT','TELLEROPENACCOUNT','TELLERDOCUMENTATION','TELLERCREWING','TELLERTECHOPS','TELLERSOURCING','TELLERTANKER','TELLERWELFARE') NOT NULL AFTER `role`;
