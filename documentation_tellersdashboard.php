                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($row['status'] == 'Waiting') { ?>
                                    <a href="documentation_process_queue.php?dashboard=<?php echo $dashboardKey; ?>&id=<?php echo $row['id']; ?>&action=call" class="btn btn-primary">Serve</a>
                                <?php } elseif ($row['status'] == 'Serving' && $row['teller'] == $_SESSION[$dashboardKey]['role']) { ?>
                                    <a href="documentation_process_queue.php?dashboard=<?php echo $dashboardKey; ?>&id=<?php echo $row['id']; ?>&action=done" class="btn btn-success">Done</a>
                                <?php } ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
